...
% 
% subplot(3,1,1);
% p=plot(t, result1.Var58(start:(a-1))-result1.Var10(start:(a-1)), 'b', t, result2.Var58(start:(a-1))-result2.Var10(start:(a-1)), 'r', t, result3.Var58(start:(a-1))-result3.Var10(start:(a-1)), 'm', t, result4.Var58(start:(a-1))-result1.Var10(start:(a-1)), t, result5.Var58(start:(a-1))-result1.Var10(start:(a-1)));  p(3).LineWidth=1.5;
