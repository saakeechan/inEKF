...
#ifndef SRC_Z1_ESTIMATOR_HPP
#define SRC_Z1_ESTIMATOR_HPP
...
public:
    ...
    Eigen::Matrix<double,12,WINDOW_SIZE+1> dv_logger;
    ...
    int idx_end                     = idx_jac_std +1;
//    int idx_dv_debugging            = idx_jac_std+1;//104
//    int idx_end                     = idx_dv_debugging + 12*(WINDOW_SIZE+1);//644
